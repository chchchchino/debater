...
def debater1_node(state: DebateState):
    ...
    system_prompt = (
        ...
        f"traits as closely as possible. Do not break character. Do not be sycophantic or overly complimentary of {debater2}. It is OK to be critical of {debater2}, and it is OK to insult {debater2} if it is appropriate.\n"
...
def debater2_node(state: DebateState):
    ...
    system_prompt = (
        ...
        f"traits as closely as possible. Do not break character. Do not be sycophantic or overly complimentary of {debater1}. It is OK to be critical of {debater1}, and it is OK to insult {debater1} if it is appropriate.\n"
        f"Here is the debate history so far:\n\n{history}\n"
